    ...
    <main className="flex flex-1 items-center justify-center py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white/50 dark:bg-background-dark/50 p-8 shadow-lg backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <button type="button" className="inline-flex w-full items-center justify-center gap-3 rounded-lg border border-slate-300 bg-background-light/70 py-2.5 px-4 text-sm font-medium transition hover:bg-primary/10 dark:border-slate-700 dark:bg-background-dark/70 dark:hover:bg-primary/20 text-slate-700 dark:text-slate-200">
