 ...
 */
// FIX: Updated function signature and return values to use `amount` instead of `predictedAmount` to match the component's state shape.
 ...
 */
// FIX: Updated function signature and return value to use `amount` instead of `predictedAmount` to match the component's state shape. The response from the Gemini API is mapped to the new structure.
